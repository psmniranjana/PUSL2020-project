...
?>
    <div style="width:100%; height:100px; background-color:#5FAF49; color:white; font-weight:bold;">
        <h1>Welcome, <?php echo $_SESSION['username']; ?>!</h1> <a style="text-decoration:none; color:white;"
            href="index.php">Logout</a>
    </div>
    <!-- display other content here -->

    <br>
    <h1>Captain User List</h1>
    <table>
        <thead>
            <tr>
                <th>ID</th>
            ...
            <?php
                ...
                if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) {
                    ...
                    echo '<input type="submit" name="update" value="Update">&nbsp &nbsp<input type="submit" name="delete" value="Delete">';
                    echo '</form>';
                    echo '<form method="post">';
                    echo '<input type="hidden" name="id" value="' . $row["id"] . '"> ';
    ...
    <br>
    <button id="insert_button">Insert Data</button><br>
    <form id="insert_form" style="display: none;" method="post" action="insert.php">
        ...
        Role:<br> <select class="form-control" name="role">

            <option value="green_captain">Green Captain</option><br>
